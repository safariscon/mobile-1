  ...
  return (
    <KeyboardAvoidingView style={styles.screen} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <TextField label="Login code" value={otp} onChangeText={setOtp} placeholder="123456" keyboardType="number-pad" maxLength={6} />
...
const createStyles = (themeColors) => StyleSheet.create({
  ...
  content: { flexGrow: 1, paddingHorizontal: 16, paddingTop: 4, paddingBottom: 16 },
  backButton: { alignItems: 'center', alignSelf: 'flex-start', flexDirection: 'row', gap: 6, marginBottom: 8, paddingVertical: 2 },
  backText: { color: themeColors.primary, fontSize: 13, fontWeight: '900' },
  heroRow: { alignItems: 'center', flexDirection: 'row', gap: 10, marginBottom: 8 },
  ...
  title: { color: themeColors.textStrong, fontSize: 18, fontWeight: '900' },
  text: { color: themeColors.muted, fontSize: 12, fontWeight: '700', lineHeight: 16, marginTop: 2 },
  button: { alignItems: 'center', backgroundColor: themeColors.primary, borderRadius: 12, height: 46, justifyContent: 'center', marginTop: 8 },
  disabled: { opacity: 0.72 },
  buttonText: { color: themeColors.white, fontSize: 15, fontWeight: '900' },
  secondaryButton: { alignItems: 'center', marginTop: 2, paddingVertical: 8 },
  secondaryText: { color: themeColors.primary, fontSize: 13, fontWeight: '900' },
  errorText: { color: themeColors.danger, fontSize: 12, fontWeight: '900', marginTop: 4 },
  successText: { color: themeColors.success, fontSize: 12, fontWeight: '900', marginTop: 4 },
});
